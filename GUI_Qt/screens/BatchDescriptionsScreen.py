...
from GUI_Qt.styles.theme_config import COLORS, COMPONENT_COLORS, FONTS
...
class DropZoneWidget(QWidget):
    ...
    def __init__(self, tr, parent=None):
        ...
        self.title_label.setStyleSheet(f"font-size: 16px; color: {COLORS['lavender_grey']};")
...
class BatchDescriptionsScreen(QWidget):
    ...
    def _update_table_theme(self):
        ...
        embedded_input_border = "rgba(141, 153, 174, 0.55)" if is_dark else "rgba(43, 45, 66, 0.30)"
    ...
    def _setup_table_row(self, row: int):
        ...
        brand = ComboBox()
        brand.addItems(self.brands)
        brand.setPlaceholderText(self.main.i18n.tr("batch.select_brand"))
        brand.setMinimumHeight(36)
